...
public class EvaluationCalc {
     ...
     * @return void
     **/
    public static void dealPredictResult() throws IOException {
        Configuration configuration = new Configuration();
        FileSystem fs = FileSystem.get(URI.create(ParamsClass.resultPath4 + "part-r-00000"), configuration);
        ...
        while ((line = bufferedReader.readLine()) != null){
            ...
            flag = trueClass == predictClass ? true : false;
            if (flag){
    ...
    public static void main(String[] args) throws IOException {
        ...
        calcMicroIndex();
        calcMacroIndex();
        for (Map.Entry<String, Double> entry : resultIndex.entrySet()) {
